...
CREATE TABLE IF NOT EXISTS access_sessions (
    ...
    entry_device_name VARCHAR(100) DEFAULT NULL,
    last_device_name VARCHAR(100) DEFAULT NULL,
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (device_id) REFERENCES devices(id) ON DELETE SET NULL,
    FOREIGN KEY (rfid_id) REFERENCES rfids(id) ON DELETE SET NULL,
    ...
    INDEX idx_access_sessions_access_group (access_group),
    UNIQUE KEY uniq_access_session_daily (rfid_code, access_group, log_date)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
